...
const renderer = document.getElementById("prerenderer")
...
function resize() {
    ...
    view.height = context.canvas.height % 2 == 1? context.canvas.height + 1 : context.canvas.height
...
function onMouseClick(x,y) {	
    Inventory.mouseClick(x,y)
}

function onMouseMove(x,y) {
    Inventory.mouseMove(x,y)
}
